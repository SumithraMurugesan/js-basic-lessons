...
//     set data (value) { 
//         if(value <= 0 ){
//             // console.log('value should be greaterthan 0');
//             // return 0;
//            // throw new Error('value should be greater than zeor');
//         }
//         this.x = value;
...
//
// --------
// createCopy() function in "DemoD.js" copied properties from one object to
// another.
